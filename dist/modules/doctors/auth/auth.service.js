...
let AuthService = class AuthService {
    ...
    async checkEmail(checkEmailDto) {
        ...
        if (doctor.status === doctorStatus_enum_1.Doctor_Status.BANNED) {
            throw new common_1.ForbiddenException('Tu cuenta ha sido rechazada o suspendida. Contacta a soporte.');
        }
        return { exists: true };
    }
